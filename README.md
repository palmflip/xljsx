...
Под капотом работает с библиотекой [exceljs](https://www.npmjs.com/package/exceljs).
...
### Настройка сборки
При использвании с TypeScript необходимо в `tsconfig.json` включить поддержку jsx и выставить прагму:
